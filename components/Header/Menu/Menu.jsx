    ...
    >
      ...
      <ul className="flex flex-col text-end gap-3 mt-10">
        <li  onClick={handleShow}>
          <Link className="w-100 block" href="/">خانه</Link>
        </li>
        <hr />
        <li  onClick={handleShow}>
          <Link className="w-100 block" href="/about-us">درباره ما</Link>
        </li>
          <hr />
        <li  onClick={handleShow}>
          <Link className="w-100 block" href="/blogs">بلاگ ها</Link>
        </li>
        <hr />
        <li  onClick={handleShow}>
          <Link className="w-100 block" href="/courses">دوره های آموزشی</Link>
        </li>
      </ul>
    </div>
  );
