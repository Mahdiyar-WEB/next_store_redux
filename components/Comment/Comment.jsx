...
const Comment = ({ details: { writer, createdAt, content } }) => {
  ...
  return (
    <div dir="rtl" className="p-4 shadow-sm border border-gray-400 rounded-lg flex flex-col gap-4 mb-4">
      ...
      {response.isResponse && (
        ...
        >
          <h3 className="text-sm text-gray-500 mb-3">در حال پاسخ به {writer.name}</h3>
          <textarea
